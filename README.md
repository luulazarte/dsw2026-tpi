...
##### 1\. 1. Clonar el repositorio y pararse en la rama "development":

##### git clone http y pegamos nuestro repo
...
##### Swagger nos lleva a "https://localhost:<http://localhost:5278>/swagger".
